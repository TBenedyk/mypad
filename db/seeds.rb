...
Property.create(name: "Sizeable house", bedroom_count: 2, latitude: 51.501000, longitude: -0.142000)
...
Property.create(name: "Isolated house", bedroom_count: 1, latitude: 50.066944, longitude: -5.746944)